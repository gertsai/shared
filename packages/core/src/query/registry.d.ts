 ...
 */
export type VectorFilterOperator = 'eq' | 'ne' | 'gt' | 'gte' | 'lt' | 'lte' | 'in' | 'nin' | 'contains';
/**
 ...
 */
export type ExecuteQuery<T extends QueryType> = (query: QueryFor<T>) => Promise<ResultFor<T>>;
/**
 * Union of all query types
 */
export type AnyQuery = NLQuery | GraphQuery | VectorQuery | RAGQuery;
/**
 * Union of all query data types
 */
export type AnyQueryData = NLQueryData | GraphQueryData | VectorQueryData | RAGQueryData;
/**
 * Union of all query metadata types
 */
export type AnyQueryMeta = NLQueryMeta | GraphQueryMeta | VectorQueryMeta | RAGQueryMeta;
/**
 * Type guard for NL query
 */
export declare function isNLQuery(query: QueryRequest): query is NLQuery;
/**
 * Type guard for Graph query
 */
export declare function isGraphQuery(query: QueryRequest): query is GraphQuery;
/**
 * Type guard for Vector query
 */
export declare function isVectorQuery(query: QueryRequest): query is VectorQuery;
/**
 * Type guard for RAG query
 */
export declare function isRAGQuery(query: QueryRequest): query is RAGQuery;
/**
 * Type guard for known query type
 */
export declare function isKnownQueryType(type: string): type is QueryType;
/**
 * Create an NL query
 */
export declare function createNLQuery(tenantId: TenantId, question: string, options?: Partial<Omit<NLQuery, 'type' | 'tenantId' | 'question'>>): NLQuery;
/**
 * Create a Graph query
 */
export declare function createGraphQuery(tenantId: TenantId, startEntityId: string, maxDepth: number, options?: Partial<Omit<GraphQuery, 'type' | 'tenantId' | 'startEntityId' | 'maxDepth'>>): GraphQuery;
/**
 * Create a Vector query
 */
export declare function createVectorQuery(tenantId: TenantId, query: string | readonly number[], topK: number, options?: Partial<Omit<VectorQuery, 'type' | 'tenantId' | 'query' | 'topK'>>): VectorQuery;
/**
 * Create a RAG query
 */

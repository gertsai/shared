 ...
 */
export class EmbeddingDeduplication implements IDeduplicationStrategy {
  readonly name = 'embedding-match';

  constructor(private readonly config: EmbeddingMatchConfig) {}
   ...
   */
  private averageCosineSimilarity(embeddings: number[][]): number {

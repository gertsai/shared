 ...
 * ```
 */
export interface AIActuator<Input = unknown, Output = unknown, SupplyType = never> extends StepActuator<Input, Output> {
    /**
 ...
 */
export declare function isAIActuator<I, O, S>(actuator: StepActuator<I, O>): actuator is AIActuator<I, O, S>;
/**
 * Type guard to check if an actuator can supply components
 */
export declare function canSupplyComponent<I, O, S>(actuator: StepActuator<I, O>): actuator is AIActuator<I, O, S> & Required<Pick<AIActuator<I, O, S>, 'supplyComponent'>>;
/**

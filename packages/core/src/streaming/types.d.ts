 ...
 */
export type AnyStreamEvent<TChunk, TResult> = StreamStartEvent | StreamChunkEvent<TChunk> | StreamErrorEvent | StreamCompleteEvent<TResult>;
/**
 ...
 */
export declare function isStreamable<TChunk, TResult>(obj: unknown): obj is IStreamable<TChunk, TResult>;
/**

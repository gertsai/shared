 ...
 */
export function unwrapOptionOrElse(option, fn) {
 ...
 * If the Option is None, returns None.
 */
export function flatMapOption(option, fn) {
 ...
 */
export function filter(option, predicate) {
 ...
 */
export const OkSchema = (valueSchema) => z.object({
    _tag: z.literal('Ok'),
    value: valueSchema,
});
/**
 ...
 */
export const ErrSchema = (errorSchema) => z.object({
    _tag: z.literal('Err'),
    error: errorSchema,
});
/**
 ...
 */
export const ResultSchema = (valueSchema, errorSchema) => z.discriminatedUnion('_tag', [OkSchema(valueSchema), ErrSchema(errorSchema)]);
/**
 * Zod schema for Some Option.
 */
export const SomeSchema = (valueSchema) => z.object({
    _tag: z.literal('Some'),
    value: valueSchema,
});
/**
 ...
 */
export const OptionSchema = (valueSchema) => z.discriminatedUnion('_tag', [SomeSchema(valueSchema), NoneSchema]);
// ============================================================================

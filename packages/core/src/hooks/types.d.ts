 ...
 */
export type ToolPreHook = (fc: FunctionCall) => boolean | null | Promise<boolean | null>;
/**
 ...
 */
export type ToolPostHook = (fc: FunctionCall) => string | null | Promise<string | null>;
/**
 * LLM pre-hook function type (for global registry).
 * Executes before LLM call.
 * @returns false to block execution, null to continue
 */
export type BeforeLLMHook = (context: LLMCallHookContext) => boolean | null | Promise<boolean | null>;
/**
 * LLM post-hook function type (for global registry).
 * Executes after LLM call.
 * @returns Modified response or null to keep original
 */
export type AfterLLMHook = (context: LLMCallHookContext) => string | null | Promise<string | null>;
/**
 * Tool pre-hook for global registry.
 * @returns false to block execution, null to continue
 */
export type BeforeToolHook = (context: ToolCallHookContext) => boolean | null | Promise<boolean | null>;
/**
 * Tool post-hook for global registry.
 * @returns Modified result or null to keep original
 */
export type AfterToolHook = (context: ToolCallHookContext) => string | null | Promise<string | null>;
...
export declare enum CheckTrigger {
...
export declare class InputCheckError extends Error {
    readonly checkTrigger: CheckTrigger;
    constructor(message: string, checkTrigger: CheckTrigger);
}
/** Error thrown by output validation hooks */
export declare class OutputCheckError extends Error {
    readonly checkTrigger: CheckTrigger;
    constructor(message: string, checkTrigger: CheckTrigger);
}
/** Callback before workflow kickoff */
export type BeforeKickoffCallback = (inputs: Record<string, unknown> | null) => Record<string, unknown> | null | Promise<Record<string, unknown> | null>;
/** Callback after workflow kickoff */
export type AfterKickoffCallback = (output: unknown) => unknown | Promise<unknown>;

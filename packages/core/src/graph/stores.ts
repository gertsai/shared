...
// ============================================================================
// Graph Data Types (re-exported for convenience)
// ============================================================================
 ...
 */
export function isEntityStore(obj: unknown): obj is IEntityStore {
  return (
    typeof obj === 'object' &&
    obj !== null &&
    typeof (obj as IEntityStore).addEntity === 'function' &&
    typeof (obj as IEntityStore).addEntities === 'function' &&
    typeof (obj as IEntityStore).getEntity === 'function' &&
    typeof (obj as IEntityStore).getEntities === 'function' &&
    typeof (obj as IEntityStore).updateEntity === 'function' &&
    typeof (obj as IEntityStore).deleteEntity === 'function'
  );
}
 ...
 */
export function isRelationshipStore(obj: unknown): obj is IRelationshipStore {
  return (
    typeof obj === 'object' &&
    obj !== null &&
    typeof (obj as IRelationshipStore).addRelationship === 'function' &&
    typeof (obj as IRelationshipStore).addRelationships === 'function' &&
    typeof (obj as IRelationshipStore).getRelationship === 'function' &&
    typeof (obj as IRelationshipStore).getRelationships === 'function' &&
    typeof (obj as IRelationshipStore).getRelationshipsByEntity === 'function'
  );
}
 ...
 */
export function isMentionStore(obj: unknown): obj is IMentionStore {
  return (
    typeof obj === 'object' &&
    obj !== null &&
    typeof (obj as IMentionStore).addEntityMention === 'function' &&
    typeof (obj as IMentionStore).addEntityMentions === 'function' &&
    typeof (obj as IMentionStore).getChunksByEntity === 'function' &&
    typeof (obj as IMentionStore).getEntityMentions === 'function' &&
    typeof (obj as IMentionStore).countEntityMentions === 'function'
  );
}
 ...
 */
export function isTextUnitStore(obj: unknown): obj is ITextUnitStore {
  return (
    typeof obj === 'object' &&
    obj !== null &&
    typeof (obj as ITextUnitStore).addTextUnit === 'function' &&
    typeof (obj as ITextUnitStore).addTextUnits === 'function' &&
    typeof (obj as ITextUnitStore).getTextUnit === 'function' &&
    typeof (obj as ITextUnitStore).getTextUnits === 'function'
  );
}
 ...
 */
export function isCommunityStore(obj: unknown): obj is ICommunityStore {
  return (
    typeof obj === 'object' &&
    obj !== null &&
    typeof (obj as ICommunityStore).addCommunity === 'function' &&
    typeof (obj as ICommunityStore).getCommunities === 'function' &&
    typeof (obj as ICommunityStore).getCommunity === 'function'
  );
}
 ...
 */
export function isGraphStore(obj: unknown): obj is IGraphStore {
  return (
    isEntityStore(obj) &&
    ...
    typeof (obj as IGraphStore).clear === 'function' &&
    typeof (obj as IGraphStore).getStats === 'function'
  );
}

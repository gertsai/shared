...
- Updated dependencies [7c3b33f]
  ...
  - @gertsai-examples/m9s-example-api-types@0.0.23
  - @gertsai/api-rlr@0.3.17

## 0.0.29

### Patch Changes

- Updated dependencies [6aa9efa]
  - @gertsai/api-core@0.8.3
  - @gertsai-examples/m9s-example-api-types@0.0.22
  - @gertsai/api-rlr@0.3.16

## 0.0.28

### Patch Changes

- 0327023: Wave 36 — m9s-example integrates @gertsai/otel + live infra re-verification of Waves 32-35.
  ...
  **Phase A — @gertsai/otel integration**:
  ...
  - Added `@gertsai/otel` workspace:_ + 4 `@opentelemetry/_`peer deps to package.json (matched workspace-resolved versions:`^0.50.0`sdk-node/exporter +`^1.30.0` resources/semantic-conventions)
  - `.env.example` documents OTEL\_\* env vars
...
- Updated dependencies [4954ce3]
  ...
  - @gertsai-examples/m9s-example-api-types@0.0.21
  - @gertsai/api-rlr@0.3.15
...
- Updated dependencies [f7549b8]
  - @gertsai/api-core@0.8.0
  - @gertsai-examples/m9s-example-api-types@0.0.19
  - @gertsai/api-rlr@0.3.13
...
- Updated dependencies [33eacbc]
  ...
  - @gertsai-examples/m9s-example-api-types@0.0.18
  - @gertsai/api-rlr@0.3.12
  - @gertsai/entity-audit@0.2.4
...
- Updated dependencies [b7a1e2d]
  ...
  - @gertsai-examples/m9s-example-api-types@0.0.15
  - @gertsai/api-rlr@0.3.9
...
- Updated dependencies [30d3b10]
  ...
  - @gertsai/runtime-context@4.0.2
  - @gertsai/async-utils@0.3.1
  - @gertsai/logger-factory@2.0.1
  - @gertsai/entity-storage@4.0.0
  - @gertsai/entity-audit@0.2.2
  - @gertsai/rest-request-manager@5.1.0
  - @gertsai/api-core@0.5.2
  - @gertsai/pg-client@3.0.0
  - @gertsai-examples/m9s-example-api-types@0.0.14
  - @gertsai/api-rlr@0.3.8
...
- fad76ac: Wave 17 — Migrate `examples/m9s-example` from `bcryptjs` to native `bcrypt` per EVID-053 H-16 (deferred from Wave 12.E-fix-2 per EVID-056 rationale "requires native module which complicates cross-platform builds").
...
- Updated dependencies [e16d41f]
  ...
  - @gertsai-examples/m9s-example-api-types@0.0.12
  - @gertsai/api-rlr@0.3.6
...
- Updated dependencies [5cfbfec]
  ...
  - @gertsai-examples/m9s-example-api-types@0.0.11
  - @gertsai/api-rlr@0.3.5
...
- Updated dependencies [11f825b]
  - @gertsai/api-core@0.3.5
  - @gertsai-examples/m9s-example-api-types@0.0.10
  - @gertsai/api-rlr@0.3.4
